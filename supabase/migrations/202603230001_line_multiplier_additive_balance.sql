...
-- Ajusta multiplicadores por linea a modo aditivo (x2 + x5 = x7).
do $$
declare
  v_constraint record;
begin
...
alter table public.game_round_line_wins
  ...
  -- Compatibilidad historica: en versiones anteriores hubo multiplicador compuesto
  -- (ej. x12, x20, x30). Mantenemos rango amplio para no invalidar filas existentes.
